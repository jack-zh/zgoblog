...
func writeDefaultData() {
	...
	p.Title = "关于"
	p.Slug = "about-me"
	p.Text = "本页面由 zBlog.Go 创建, 这只是个测试页面."
	p.Tags = []string{}
	...
	p2.Title = "好友"
	p2.Slug = "friends"
	p2.Text = "本页面由 zBlog.Go 创建, 这只是个测试页面."
	p2.Tags = []string{}
	...
	s := map[string]string{
		...
		"site_keywords":      "zBlog.Go,Golang,Blog",
	...
	// Storage.Set("navigators", []*navItem{n, n1, n2})
