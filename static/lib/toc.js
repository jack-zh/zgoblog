/** Generated TOC
    ...
    page if you did not provide a ztoc container). To override this,
...
generated_toc = {
  generate: function() {
    ...
    generate_from = '0';
    generate_for = 'unset';
    tocparent = document.getElementById('ztoc');
    if (tocparent) {
      // there is a div class="ztoc" in the document
  ...
  wrapOpenClose: function(a, cur_list_el) {
    ...
    return function(e) {
      ...
      a.firstChild.nodeValue = '[目录' + (d == 'block' ? '+]' : '-]');
